			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>super_admin/blog_manager"><i class="icon-font"></i><span class="hidden-tablet">Blog Manager</span></a></li>
                                                <li><a class="ajax-link" href="<?php echo base_url();?>super_admin/comments_manager"><i class="icon-font"></i><span class="hidden-tablet">Comments Manager</span></a></li>
