...
<!--                        <th>Blog Short Description</th>
                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td class="center"><?php echo $v_comments->blog_id?></td>
<!--                        <td><?php //echo $v_blog->blog_short_description?></td>
                        ...
                        <td class="center">
                            ...
                            {
                            ?>
                            <a class="btn btn-success" href="<?php echo base_url();?>super_admin/unpublished_comments/<?php echo $v_comments->comments_id?>">
                            ...
                            ?>
                            <a class="btn btn-danger" href="<?php echo base_url();?>super_admin/published_comments/<?php echo $v_comments->comments_id?>">
                                <i class="icon-ok icon-white"></i>  
                                                                          
                            </a>
                            <?php } ?>
                            <a class="btn btn-info" href="<?php echo base_url();?>super_admin/edit_comments/<?php echo $v_comments->comments_id?>" title="Edit">
